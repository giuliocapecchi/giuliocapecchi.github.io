...
const Portfolio: React.FC<PortfolioProps> = ({ projects }) => {
    ...
    return (
        ...
        } text-white text-center p-3 bg-gray-600/30 bg-opacity-75 rounded-lg shadow-lg max-w-4xl mx-auto ${isMobile ? 'h-[440px]' : 'h-[500px]'} relative flex flex-col items-center pt-16`} // Altezza fissa e posizione relativa
        >
